...
// Common errors
var (
	AuthError               error = errors.New("authentication failed")
	LoadingError            error = errors.New("server is busy loading dataset in memory")
	ParseError              error = errors.New("parse error")
	PipelineQueueEmptyError error = errors.New("pipeline queue empty")
)
