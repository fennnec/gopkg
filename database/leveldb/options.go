...
const (
	NoCompression     = CompressionOpt(C.leveldb_no_compression)
	SnappyCompression = CompressionOpt(C.leveldb_snappy_compression)
)
...
func (o *Options) SetCache(c *Cache) {
	C.leveldb_options_set_cache(o.opt, c.cache)
}
