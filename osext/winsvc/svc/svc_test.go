...
import (
	"chai2010.gopkg/osext/winsvc/mgr"
	"chai2010.gopkg/osext/winsvc/svc"
	"io/ioutil"
	"os"
	"os/exec"
	"path/filepath"
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "chai2010.gopkg/osext/winsvc/example").CombinedOutput()
	if err != nil {
